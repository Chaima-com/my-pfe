<?php 
    ...
    if(isset($_POST['submit'])){
        $label = $_POST['label'];
        if(editCategory($id,$label)){
            header('location: categories.php');
        }
    }
    $editedCategory = mysqli_fetch_assoc(getCategory($id));
?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <input type="text" name="label" value="<?= $editedCategory['label'] ?>" placeholder="entrer libelle de la categorie ..." required class="form-control" />
                                        </div>
                                        <div class="form-group">
